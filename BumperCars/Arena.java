...
public class Arena
{
	...
	// A 2-d array representing the arena. The NW corner is position 0,0.
	// A null entry indicates that that position in the arena is
	// unoccupied.
	private Car[][] arena;
    ...
    for (int ns=0; ns < nsSize; ns++)
    {
   	 ...
   	 {
                	if (Simulation.DEBUG)
                    	System.out.println("Arena: car at " + ns + "," + ew
   					+ " is going.");
